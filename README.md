...
Based on the 20 QA pairs generated by Gemini 3.0 Flash, here are the average ROUGE scores comparing Naive RAG vs. Contextual Retrieval on this dataset:

| Method | ROUGE-1 | ROUGE-2 | ROUGE-L |
|---|---|---|---|
| Naive RAG | 0.7349 | 0.6615 | 0.6978 |
| Contextual Retrieval | 0.6560 | 0.5854 | 0.6261 |

*(Note: Contextual Retrieval scores were slightly lower in this specific run due to the chunking strictness and test queries, but effectively demonstrates the pipeline mechanics).*

## Application Demo

*Below is a screen recording of the application in action:*
